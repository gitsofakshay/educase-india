...
export default function Home() {
 return (
    <div className="flex justify-center items-center min-h-screen px-4">
      <div className="w-full max-w-sm bg-[#f2f2f2] border border-gray-300 rounded-sm shadow-md p-6 flex flex-col justify-between h-[700px]">        
        <div className="flex flex-col justify-end h-full">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/login">
              <button className="w-full bg-gray-400 text-black py-2 rounded-md font-medium">
